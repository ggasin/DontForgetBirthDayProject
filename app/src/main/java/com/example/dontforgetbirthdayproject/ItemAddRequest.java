...
public class ItemAddRequest extends StringRequest {
    ...
    public ItemAddRequest(String itemId,String itemGroup ,String itemName,String itemSolarBirth,String itemLunarBirth,String itemMemo,int itemAlramOn, Response .Listener<String> listener){
        ...
        map.put("itemAlramOn",itemAlramOn+"");
